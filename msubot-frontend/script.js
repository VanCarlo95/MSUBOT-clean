...
function addMessageWithTypewriterEffect(sender, message) {
  ...
  let formattedText = message
    ...
    .replace(
      /([.!?])\s+(Overview|Key Features|Learning Outcomes|Special Features|Technical Roles|Industries|Growth Path)/g,
      "$1\n\n$2"
    )
    // Ensure proper spacing around headings
    .replace(
      /(Overview|Key Features|Learning Outcomes|Special Features|Technical Roles|Industries|Growth Path):/g,
      "\n$1:\n"
    )
